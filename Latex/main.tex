...
\input{includes} % various packages needed for maths 
...
Since the early 2000s, the role of renewable energy in mitigating greenhouse gas emissions and addressing climate change has become increasingly evident. In response to this growing awareness, NM introduced the Solar Market Development Tax Credit (SMDTC) in 2006. %This initiative was aimed at encouraging the adoption of solar energy through financial incentives. 
...
\customsection{Current trends  and distribution}{Current trends and distribution of residential solar PV in NM} %header shows the name in first braces
...
Racial diversity & \begin{tabular}[c]{@{}l@{}} Racial diversity index calculated as the sum\\ of squared percentage of each race \end{tabular} & \begin{tabular}[c]{@{}l@{}}Authors' calculation based on \\ Census Bureau (DP05) \end{tabular}  \\
...
Electricity price & Average annual electricity price (cent/kWh) & \begin{tabular}[c]{@{}l@{}}Authors' calculation based on U.S. \\ Energy Information \\ Administration\end{tabular} \\
...
\begin{table}[!ht]
\centering
\caption{Regression results for the extensive margin of solar adoption}
...
\\[-1.8ex]\hline
\hline \\[-1.8ex]
& \multicolumn{4}{c}{Dependent Variable: Having Installation (binary)} \\ \cline{2-5}
\\[-1.8ex] & \multicolumn{1}{c}{Linear Probability} & \multicolumn{1}{c}{Logit Marginal Effect} & \multicolumn{1}{c}{Linear Probability} & \multicolumn{1}{c}{Logit Marginal Effect} \\
\hline \\[-1.8ex]
Hispanic & 0.001$^{**}$ & 0.001$^{***}$ & 0.001$^{*}$ & 0.001 \\
& (0.000) & (0.000) & (0.000) & (0.000) \\
White & 0.003$^{***}$ & 0.003$^{***}$ & 0.003$^{***}$ & 0.005$^{***}$ \\
& (0.000) & (0.000) & (0.000) & (0.001) \\
Log Area Median Income & 0.120$^{***}$ & 0.140$^{***}$ & 0.134$^{***}$ & 0.146$^{***}$ \\
& (0.019) & (0.018) & (0.020) & (0.019) \\
Bachelor & 0.003$^{***}$ & 0.004$^{***}$ & 0.003$^{***}$ & 0.003$^{***}$ \\
& (0.001) & (0.001) & (0.001) & (0.001) \\
Disadvantaged & 0.003 & 0.013 & 0.001 & 0.013 \\
...
\autoref{tab:count_regression} displays the intensive margin of solar adoption estimation within the census tract-year. We also estimate an OLS regression with the system count as the dependent variable (model (2)) for comparison with the marginal effect from the NB model. %The linear model yields estimates similar to the NB marginal effects. 
...
\begin{table}[!ht]
\caption{Regression results for the intensive margin of solar adoption}
...
\\[-1.8ex]\hline
\hline \\[-1.8ex]
 & \multicolumn{4}{c}{Dependent Variable: System Count (if $>0$)} \\ \cline{2-5}
 & \multicolumn{1}{c}{(1)} & \multicolumn{1}{c}{(2)} & \multicolumn{1}{c}{(3)} & \multicolumn{1}{c}{(4)} \\
 & NB & OLS & OLS with quadratic term & NB with lagged count  \\ 
 & Marginal Effect &  &  & Marginal Effect \\ \cline{1-5}
Hispanic & 0.027** & 0.022 & 0.016 & 0.034** \\
 & (0.012) & (0.018) & (0.018) & (0.014) \\
White & -0.039 & 0.050 & 0.414** & 0.079 \\
 & (0.025) & (0.037) & (0.198) & (0.159) \\
\multicolumn{3}{l}{$(\text{White})^2$} & -0.004** &  \\
 &  &  & (0.002) &  \\
Log Area Median Income & 4.064*** & 4.051*** & 3.987*** & 3.704*** \\
 & (0.663) & (0.949) & (0.950) & (0.732) \\
Bachelor & 0.102*** & 0.106*** & 0.106*** & 0.067*** \\
 & (0.017) & (0.025) & (0.025) & (0.018) \\
Disadvantage & -1.822*** & -1.110** & -1.105** & -1.768*** \\
 & (0.384) & (0.563) & (0.563) & (0.418) \\
Credit & 6.491*** & 7.145*** & 7.274*** & 2.439*** \\
 & (0.609) & (0.952) & (0.954) & (0.667) \\
Lagged System Count & & & & 0.364*** \\
 & & & & (0.020) \\ \cline{1-5}
Control & Yes & Yes & Yes & Yes \\
Year FE & Yes & Yes & Yes & Yes \\
County FE & Yes & Yes & Yes & Yes \\
Year & All & All & All & 2011 - 2022 \\
Observations & 3,849 & 3,849 & 3,849 & 3,628 \\
\multicolumn{2}{l}{R-squared} & 0.45 & 0.45 &  \\ \hline
\hline \\[-1.8ex]
\textit{Note:} & \multicolumn{4}{r}{$^{*}$p$<$0.05; $^{**}$p$<$0.01; $^{***}$p$<$0.001} \\
\end{tabular}}
\end{table}
...
\begin{table}[!ht]
\caption{Negative binomial marginal effects for system count by state credit availability}
\centering
\singlespacing
...
\\[-1.8ex]\hline
\hline \\[-1.8ex]
 & \multicolumn{3}{c}{Dependent variable: System count (if $>0$)} \\ \cline{2-4}
 & (1) & (2) & (3) \\
 & SMDTC & No credit & NSMDTC\\
 & 2010-2016 & 2017-2019 & 2020-2022 \\ \cline{1-4}
Hispanic & 0.011 & 0.063** & -0.016 \\
 & (0.009) & (0.032) & (0.032) \\
White & 0.014 & 0.343*** & -0.000 \\
 & (0.028) & (0.110) & (0.053) \\
Log area median income & 3.722*** & 5.950*** & -2.600 \\
 & (0.504) & (1.920) & (1.664) \\
Bachelor & 0.111*** & 0.026 & 0.072* \\
 & (0.013) & (0.040) & (0.040) \\
Disadvantage & -0.560** & -1.600* & -3.388*** \\
 & (0.280) & (0.918) & (0.975) \\
Log population & 4.256*** & 2.526 & 3.151 \\
 & (0.767) & (2.764) & (2.436) \\
Electricity & 0.013 & 0.204*** & -0.112** \\
 & (0.015) & (0.052) & (0.047) \\
Electricity price & 0.218* & 0.301 & 0.732 \\
 & (0.119) & (0.416) & (0.474) \\
Installation price & -1.336*** & -4.248*** & -36.52*** \\
 & (0.131) & (0.805) & (8.084) \\
Log total housing unit & 0.403 & 9.155*** & 5.507** \\
 & (0.765) & (2.846) & (2.422) \\
Urban & -0.021*** & 0.061*** & 0.086*** \\
 & (0.004) & (0.016) & (0.015) \\
Owner occupied & 0.017*** & 0.226*** & 0.263*** \\
 & (0.006) & (0.035) & (0.034) \\
...
%The state-level incentives did not significantly affect education-level disparities. The coefficients in 2017-2019 and 2020-2022 are positive but not significant, suggesting that potential information barriers may still exist but have been alleviated by some other unobserved interventions over the years. 
% There has been some progress in making solar technology more accessible across different educational levels in New Mexico.
...
We estimate model specification (5) of equation (\ref{reg_3}) for the two tax credit program phases separately to examine whether some of the distributional effects change over time. \autoref{tab:reg_by_program} reports the regression results. \autoref{fig:coefficient_trend} shows the time trend of the household-level explanatory variable coefficients.
...
% In the first program period (before 2016), around 60\% of the systems claimed tax credits, whereas in the second period (after 2020), the rate dropped to 36\%. 
...
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
 & \multicolumn{5}{c}{\textit{Dependent variable: Log(Tax credit claimed)}} \\ 
\cline{2-6}  
\\[-1.8ex] & (1) & (2) & (3) & (4) & (5)\\ 
\\[-1.8ex] & Full sample & Full sample & Full sample & SMDTC & NSMDTC\\ 
\hline \\[-1.8ex] 
 System capacity & 0.109$^{***}$ & 0.112$^{***}$ & 0.115$^{***}$ & 0.130$^{***}$ & 0.108$^{***}$ \\ 
  & (0.001) & (0.001) & (0.002) & (0.003) & (0.002) \\ 
  Log Zestimate & 0.049$^{***}$ & 0.070$^{***}$ & 0.059$^{***}$ & 0.237$^{***}$ & $-$0.086$^{***}$ \\ 
  & (0.010) & (0.013) & (0.013) & (0.021) & (0.016) \\ 
  Year built & $-$0.001$^{***}$ & $-$0.001$^{***}$ & $-$0.001$^{***}$ & $-$0.002$^{***}$ & $-$0.001$^{***}$ \\ 
  & (0.0002) & (0.0002) & (0.0002) & (0.0003) & (0.0002) \\ 
  Log Housing size (sq ft) & 0.083$^{***}$ & 0.057$^{***}$ & 0.054$^{***}$ & $-$0.036 & 0.135$^{***}$ \\ 
  & (0.015) & (0.015) & (0.015) & (0.024) & (0.019) \\ 
  No. of Bedrooms & 0.026$^{***}$ & 0.027$^{***}$ & 0.028$^{***}$ & 0.028$^{***}$ & 0.018$^{***}$ \\ 
...
\\[-1.8ex]\hline
\hline \\[-1.8ex]
& \multicolumn{4}{c}{Dependent Variable: System Count} \\ \cline{2-5}
\\[-1.8ex] & \multicolumn{1}{c}{Linear Probability} & \multicolumn{1}{c}{Logit Marginal Effect} & \multicolumn{1}{c}{Linear Probability} & \multicolumn{1}{c}{Logit Marginal Effect} \\
\hline \\[-1.8ex]
Hispanic & 0.001$^{**}$ & 0.001$^{***}$ & 0.001$^{*}$ & 0.001 \\
& (0.000) & (0.000) & (0.000) & (0.000) \\
...
Disadvantaged & 0.003 & 0.013 & 0.001 & 0.013 \\
& (0.013) & (0.012) & (0.013) & (0.012) \\
Log population & 0.022 & 0.043$^{*}$ & 0.037 & 0.072$^{***}$ \\
& (0.023) & (0.022) & (0.025) & (0.024) \\
Electricity & -0.002$^{***}$ & -0.001$^{***}$ & -0.002$^{***}$ & -0.002$^{***}$ \\
& (0.000) & (0.000) & (0.001) & (0.001) \\
Electricity price & -0.012$^{***}$ & -0.010$^{**}$ & -0.010$^{**}$ & -0.010$^{**}$ \\
& (0.005) & (0.005) & (0.005) & (0.005) \\
Installation price & 0.020$^{***}$ & 0.030$^{***}$ & 0.021$^{***}$ & 0.029$^{***}$ \\
...
Credit & 6.491*** & 7.145*** & 7.274*** & 2.439*** \\
 & (0.609) & (0.952) & (0.954) & (0.667) \\
Log population & 6.400*** & 6.786*** & 6.768*** & 5.011*** \\
 & (1.005) & (1.374) & (1.374) & (1.107) \\
Electricity & -0.002 & 0.017 & 0.017 & -0.009 \\
 & (0.018) & (0.026) & (0.026) & (0.020) \\
Electricity price & 0.179 & -0.390* & -0.368* & 0.277 \\
 & (0.156) & (0.219) & (0.220) & (0.174) \\
...
\begin{table}[H]
\caption{Results for regression model (\ref{reg_2}) with full sample (all census tract-year)}
\label{tab:count_regression_full_unconditional}
\centering
\singlespacing
...
\\[-1.8ex]\hline
\hline \\[-1.8ex]
 & \multicolumn{2}{c}{Dependent Variable: System Count} \\ \cline{2-3}
 & \multicolumn{1}{c}{(1)} & \multicolumn{1}{c}{(2)} \\
 & \multicolumn{1}{c}{NB Marginal Effect} & \multicolumn{1}{c}{OLS} \\ \cline{1-3}
Hispanic & 0.025*** & 0.037*** \\
 & (0.009) & (0.011) \\
White & 0.111*** & 0.013 \\
 & (0.013) & (0.011) \\
Log Area Median Income & 3.682*** & 3.002*** \\
 & (0.466) & (0.568) \\
Bachelor & 0.075*** & 0.123*** \\
 & (0.013) & (0.017) \\
Disadvantage & -1.656*** & -0.653* \\
 & (0.283) & (0.368) \\
Credit & 6.868*** & 7.091*** \\
 & (0.502) & (0.658) \\
Log population & 3.221*** & 3.917*** \\
 & (0.660) & (0.684) \\
Electricity & -0.025** & -0.035** \\
 & (0.013) & (0.015) \\
Electricity price & 0.093 & -0.605*** \\
 & (0.112) & (0.134) \\
Installation price & -3.731*** & -2.853*** \\
 & (0.179) & (0.183) \\
Log total housing unit & 2.887*** & 0.504 \\
 & (0.644) & (0.639) \\
Urban & 0.003 & 0.008* \\
 & (0.004) & (0.005) \\
Owner occupied & 0.030*** & 0.101*** \\
 & (0.006) & (0.007) \\
...
\begin{table}[H]
\caption{Negative binomial marginal effects for system count by income quartile}
\centering
\singlespacing
...
Hispanic & 0.057** & 0.127*** & 0.014 \\
 & (0.022) & (0.040) & (0.013) \\
White & 0.106* & -0.570*** & 0.255*** \\
 & (0.056) & (0.080) & (0.039) \\
Log area median income & 0.904 & 6.111*** & 1.665* \\
 & (1.046) & (2.072) & (0.878) \\
Bachelor & 0.006 & 0.293*** & 0.078*** \\
 & (0.031) & (0.047) & (0.020) \\
Disadvantage & 2.182** & 4.710 & -0.301 \\
 & (1.017) & (11.47) & (0.361) \\
Credit & 3.086*** & 11.62*** & 4.869*** \\
 & (0.850) & (1.478) & (0.669) \\
Log population & 2.684* & 13.82*** & 4.870*** \\
 & (1.390) & (2.797) & (1.207) \\
Electricity & 0.010 & 0.114* & -0.049** \\
 & (0.022) & (0.068) & (0.020) \\
Electricity price & -0.060 & 0.581 & 0.185 \\
 & (0.191) & (0.500) & (0.182) \\
Installation price & -2.785*** & -6.111*** & -3.374*** \\
 & (0.322) & (0.679) & (0.254) \\
Log total housing unit & 0.129 & -1.363 & 1.556 \\
 & (1.389) & (2.812) & (1.209) \\
Urban & 0.005 & -0.025* & 0.022*** \\
 & (0.009) & (0.015) & (0.007) \\
Owner occupied & 0.050*** & 0.026 & 0.079*** \\
 & (0.014) & (0.029) & (0.011) \\
...
\begin{table}[H] \centering 
  \caption{Full results for regression model (\ref{reg_4})} 
  \label{tab:reg_5_full} 
  \centering
  \singlespacing
  \resizebox{1\textwidth}{!}{
\begin{tabular}{@{\extracolsep{5pt}}lccccc} 
...
\hline \\[-1.8ex] 
 System capacity & 0.109$^{***}$ & 0.112$^{***}$ & 0.115$^{***}$ & 0.130$^{***}$ & 0.108$^{***}$ \\ 
  ...
  No. of Bedrooms & 0.026$^{***}$ & 0.027$^{***}$ & 0.028$^{***}$ & 0.028$^{***}$ & 0.018$^{***}$ \\ 
  & (0.005) & (0.005) & (0.005) & (0.008) & (0.006) \\ 
  Population share with bachelor degree ($>$25) &  & $-$0.378$^{***}$ & $-$0.358$^{***}$ & $-$0.611$^{***}$ & $-$0.097$^{**}$ \\ 
  &  & (0.038) & (0.038) & (0.070) & (0.042) \\ 
  Owner occupancy rate &  & $-$0.165$^{***}$ & $-$0.194$^{***}$ & $-$0.082$^{*}$ & $-$0.005 \\ 
  &  & (0.020) & (0.026) & (0.042) & (0.054) \\ 
  Mortgage rate &  & 0.136$^{***}$ & 0.119$^{***}$ & $-$0.046 & 0.080 \\ 
